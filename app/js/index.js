...
function renderRecommendationOptions(options) {
    ...
    options.forEach((option, idx) => {
        ...
        item.addEventListener("click", () => {
            ...
            updateRecommendationSummaryForOption(option, "Selected starter option");
        });
...
function handleGenerateRecommendationsClick(triggerSource = "manual") {
    ...
    recommendationElements.applyButton.disabled = false;
    updateRecommendationSummaryForOption(readyPayload.options[0]);
    setRecommendationStatus("Starter recommendations are ready. Select an option to apply.");
