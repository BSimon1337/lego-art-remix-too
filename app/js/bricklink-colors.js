...
window.ALL_BRICKLINK_SOLID_COLORS = ALL_BRICKLINK_SOLID_COLORS;
window.HEX_TO_COLOR_NAME = HEX_TO_COLOR_NAME;
window.COLOR_NAME_TO_ID = COLOR_NAME_TO_ID;
window.BRICKLINK_STUD_COLORS = BRICKLINK_STUD_COLORS;
window.BRICKLINK_TILE_COLORS = BRICKLINK_TILE_COLORS;
window.ALL_VALID_BRICKLINK_COLORS = ALL_VALID_BRICKLINK_COLORS;
window.PIXEL_TYPE_OPTIONS = PIXEL_TYPE_OPTIONS;
window.PIXEL_TYPE_TO_FLATTENED = PIXEL_TYPE_TO_FLATTENED;

export {
    ALL_BRICKLINK_SOLID_COLORS,
    HEX_TO_COLOR_NAME,
    COLOR_NAME_TO_ID,
    BRICKLINK_STUD_COLORS,
    BRICKLINK_TILE_COLORS,
    ALL_VALID_BRICKLINK_COLORS,
    PIXEL_TYPE_OPTIONS,
